      ...
      <footer className="bg-white border-t border-gray-100">
        <div className="mx-auto max-w-[960px] px-6 py-6 text-center text-[12px] text-[#999]">
          <div className="mb-2 flex flex-wrap justify-center gap-4">
            <a href="#" className="transition hover:text-[#555]">Conditions g&eacute;n&eacute;rales de vente</a>
            <span>|</span>
            <a href="#" className="transition hover:text-[#555]">Politique de confidentialit&eacute;</a>
            <span>|</span>
            <a href="#" className="transition hover:text-[#555]">Mentions l&eacute;gales</a>
          </div>
        </div>
      </footer>
    </div>
