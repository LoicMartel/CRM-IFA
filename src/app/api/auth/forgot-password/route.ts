...
export async function POST(req: NextRequest) {
  try {
    ...
    const subject = "Réinitialisation de votre mot de passe — La Closing Académie";
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; color: #1a2a3a; line-height: 1.7;">
        ...
        <div style="margin: 24px 0; text-align: center;">
          <a href="${resetLink}" style="display: inline-block; padding: 12px 32px; background: linear-gradient(135deg, #FF6B35 0%, #e65100 100%); color: white; text-decoration: none; border-radius: 8px; font-weight: 700; font-size: 15px;">
