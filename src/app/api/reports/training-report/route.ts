...
async function enrichWithClaude(
  ...
  const prompt = `Tu es un expert en rédaction de reporting de formation professionnelle pour IFA Formation.
...
function buildLearnerSections(
  ...
  el.push(new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 200 }, children: [new TextRun({ text: "Consultant Expert – IFA Formation", font: "Arial", size: 22, color: GRAY_DARK })] }));
  ...
  el.push(new Table({
    ...
    rows: [
      ...
      ["Formateur", "Loïc Martel – Consultant Expert, IFA Formation"],
  ...
  el.push(new Paragraph({ spacing: { after: 80 }, children: [new TextRun({ text: "Loïc Martel – Consultant Expert – IFA Formation", bold: true, font: "Arial", size: 21, color: BLUE_DARK })] }));
        ...
        footers: {
          default: new Footer({
            children: [new Paragraph({
              ...
              children: [new TextRun({ text: "Loïc Martel – IFA Formation", font: "Arial", size: 16, color: "666666" })],
            })],
          }),
        },
