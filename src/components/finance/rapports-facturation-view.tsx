  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 md:grid-cols-5">
        {[
          { label: "Total", value: kpis.total, color: "#1a2a3a" },
          { label: "Encaissé", value: kpis.encaisse, color: "#006100" },
          { label: "Facturé", value: kpis.facture, color: "#9c0006" },
          { label: "En cours", value: kpis.en_cours, color: "#1f4e79" },
          { label: "Non fait", value: kpis.non_fait, color: "#888888" },
        ].map((k) => (
